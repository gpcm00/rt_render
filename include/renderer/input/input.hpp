...
namespace input {
	...
	/*
		Unique identifier for action. Needs to be synchronized / mapped to server's action identifiers.
	*/
	...
	*/
	struct Action {
		...
		// May represent normalized axis strength or mouse position or delta on one axis.
		float axis;
	};

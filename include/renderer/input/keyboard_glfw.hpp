...
class KeyboardGLFW : public KeyboardInterface {
  ...
  public:
    KeyboardGLFW(WindowSystem *window_system) {
        ...
        this->window_system->register_create_window_callback(
    ...
    virtual void pre_update() override { glfwPollEvents(); }

    virtual void post_update() override { key_events.clear(); }
    ...
    static void key_callback(GLFWwindow *window, int key, int scancode,
        ...
        auto window_user_data =
            static_cast<WindowUserData *>(glfwGetWindowUserPointer(window));
        auto keyboard_interface =
            static_cast<KeyboardGLFW *>(window_user_data->keyboard_interface);
        // generate key event
